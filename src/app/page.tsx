...
export default function Home() {
  ...
  const openLastProject = () => {
    ...
    if (lastProject) openDrawer(lastProject);
  };
  ...
  return (
    <main className="relative min-h-screen">
      {/* Claude Banner */}
      <div
        className="group flex w-full cursor-pointer items-center justify-center py-2.5"
        style={{ backgroundColor: "#2563EB" }}
        onClick={openLastProject}
      >
        <p className="text-sm font-medium text-white">
          Designed by me, built with Claude 🤖{" "}
        ...
        >
          ...
          {tabs.map((tab) => (
            <button
              ...
              style={{
                color: activeTab === tab.id ? "#ffffff" : "var(--color-foreground)",
                minWidth: 84,
                height: "100%",
              }}
            >
